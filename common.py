...
if __name__ == '__main__':
    ...
    # check_order_status("65bcd9bef3801dc51fe9dd82", 240206003570066)
    # print(datetime.datetime.strptime(str(datetime.datetime.today().date()), '%Y-%m-%d')
    # )
    # print(round_to_tick_multiple(411.53333))
    # print(round((math.ceil(508.14 * 20)/20), 2))
